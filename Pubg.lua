...
function Main()
    ...
    -- Cancel နှိပ်ရင် ဘာမှမလုပ်ဘဲ Menu မှာပဲ ပြန်နေအောင် လုပ်ထားသည်
    if menu == nil then 
        -- မည်သည့်အရာမှ မလုပ်ပါ (Script ဆက်ပွင့်နေမည်)
    elseif menu == 1 then Outfit() 
    elseif menu == 2 then Bag() 
    elseif menu == 3 then Helmet() 
    elseif menu == 4 then Gun() 
    elseif menu == 5 then ANTENA() 
    elseif menu == 6 then os.exit() -- Exit နှိပ်မှသာ ပိတ်မည်
    end
end
